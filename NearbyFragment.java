...
//                new String[]{String.valueOf(latitude),"0.001",String.valueOf(latitude),"-0.001",String.valueOf(longitude),"0.001",String.valueOf(longitude),"-0.001"});
        ...
        googleMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoContents(Marker arg0) {
                ...
                im.setImageDrawable(getResources().getDrawable(R.drawable.droidman01));
        ...
        while (c.moveToNext()){
            ...
            googleMap.addMarker(new MarkerOptions().position(cLocation).title(itemTitle).snippet(Detail));
        }
